            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                    <div class="flex flex-col items-center text-center mb-6">
                        ...
                        <h4 class="text-xl font-black text-formal-primary">Budi Santoso</h4>
                    ...
                    <div class="space-y-4 border-t border-slate-50 pt-6">
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-bold text-formal-secondary">1234567890123456</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-[10px] font-black text-slate-400 uppercase">Gender</span>
                            <span class="text-sm font-bold text-formal-secondary">Laki-laki</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-[10px] font-black text-slate-400 uppercase">Tgl Lahir</span>
                            <span class="text-sm font-bold text-formal-secondary">12 Juni 1990</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                    ...
                    <div class="space-y-6">
                        <div class="relative pl-6 border-l-2 border-formal-accent/20">
                            ...
                            <p class="text-[10px] font-black text-formal-accent uppercase">15 Maret 2026
                            </p>
                            <p class="text-sm font-bold text-formal-primary mt-1">Gastritis Akut</p>
                        </div>
                    </div>
                </div>
