            ...
            @forelse($listJadwal as $jadwal)
                <div
                    ...
                    <p class="text-3xl font-black text-formal-primary mb-6 relative z-10 transition-colors">
                        {{ $jadwal->hari_mulai }} {{ ($jadwal->hari_selesai && $jadwal->hari_selesai !== $jadwal->hari_mulai) ? '- ' . $jadwal->hari_selesai : '' }}</p>
                    ...
                    <div class="space-y-4 relative z-10">
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm font-bold text-formal-secondary transition-colors">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm font-bold text-formal-secondary transition-colors">Kuota:
                                {{ $jadwal->kuota_maksimal }} Pasien</p>
                        </div>
                    </div>
                </div>
            @empty
                <div class="col-span-full bg-white p-8 rounded-[2.5rem] border border-slate-100 text-center text-slate-400 font-semibold">
                    Belum ada jadwal praktik yang terdaftar untuk Anda.
                </div>
            @endforelse
