    ...
    <div class="p-15 relative min-h-screen overflow-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div
                ...
                <p class="text-3xl font-black text-formal-accent tracking-tighter">15</p>
            ...
            <div
                ...
                <p class="text-3xl font-black text-sky-600 tracking-tighter">10</p>
        ...
        <div class="mt-10">
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-formal-secondary text-sm font-medium italic">Senin, 06 April 2026</p>
                </div>
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-cyan-50/50 transition-colors group">
                            <td class="px-8 py-6">
                                <span
                                    class="w-10 h-10 bg-slate-100 text-slate-600 rounded-lg flex items-center justify-center font-black text-sm group-hover:bg-formal-accent group-hover:text-white transition-all">
                                    A-011
                                </span>
                            </td>
                            <td class="px-8 py-6">
                                <p class="font-bold text-formal-primary">Budi Santoso</p>
                        ...
                        <tr class="hover:bg-cyan-50/50 transition-colors group">
                            <td class="px-8 py-6">
                                <span
                                    class="w-10 h-10 bg-sky-50 text-sky-600 rounded-lg flex items-center justify-center font-black text-sm group-hover:bg-formal-accent group-hover:text-white transition-all">
                                    A-010
                                </span>
                            </td>
                            <td class="px-8 py-6">
