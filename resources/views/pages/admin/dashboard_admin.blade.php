...
@section('content')
    <div class="p-15  relative min-h-screen overflow-hidden">
        ...
        <div class="mb-10 animate-in fade-in slide-in-from-left-6 duration-1000">
            <div class="flex items-center gap-3 mb-2">
                <div class="p-2 bg-white rounded-xl shadow-sm border border-slate-100">
                    <svg class="w-6 h-6 text-formal-accent" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                ...
                <h2 class="text-3xl font-black text-formal-primary tracking-tight">Admin <span
                        class="text-formal-primary italic">Dashboard</span>
                </h2>
            </div>
            <p class="text-formal-secondary font-medium ml-12">Monitoring sistem pendaftaran dan operasional <span
                    class="font-bold text-formal-primary">MedisGo</span> hari ini.</p>
        </div>
        {{-- Bagian Header End --}}
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
            ...
            {{-- Card Dokter Start --}}
            <div
                class="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-cyan-100/50 hover:-translate-y-2 transition-all duration-500 group animate-in zoom-in-95 duration-700">
                <div class="flex justify-between items-start mb-4">
                    <div
                        class="w-12 h-12 bg-cyan-50 text-formal-accent rounded-2xl flex items-center justify-center group-hover:bg-formal-accent group-hover:text-white transition-all shadow-inner">
            ...
            {{-- Card Pasien Start --}}
            <div
                class="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-sky-100/50 hover:-translate-y-2 transition-all duration-500 group animate-in zoom-in-95 duration-700 delay-100">
                <div class="flex justify-between items-start mb-4">
                    <div
                        class="w-12 h-12 bg-sky-50 text-sky-600 rounded-2xl flex items-center justify-center group-hover:bg-sky-600 group-hover:text-white transition-all shadow-inner">
                        <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path fill-rule="evenodd"
            ...
            {{-- Card Jadwal Start --}}
            <div
                class="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-cyan-100/50 hover:-translate-y-2 transition-all duration-500 group animate-in zoom-in-95 duration-700 delay-200">
                <div class="flex justify-between items-start mb-4">
                    <div
                        class="w-12 h-12 bg-cyan-50 text-formal-accent rounded-2xl flex items-center justify-center group-hover:bg-formal-accent group-hover:text-white transition-all shadow-inner">
                        <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div
                ...
                <div class="flex items-center justify-between mb-8">
                    <h4 class="text-xl font-black text-formal-primary tracking-tight">Aksi Cepat</h4>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <a href="{{ route('ShowDoktersAdmin') }}"
                        class="flex flex-col items-center p-6 bg-slate-50 rounded-3xl hover:bg-formal-accent group transition-all duration-300">
                        <div
                            class="w-12 h-12 mb-3 rounded-2xl bg-white flex items-center justify-center text-formal-accent group-hover:scale-110 transition-transform">
            ...
            <div
                ...
                <div class="relative mb-6">
                    <div
                        class="absolute inset-0 bg-cyan-400 rounded-full blur-2xl opacity-20 group-hover:opacity-40 transition-opacity">
                    </div>
                    <div
                        class="relative w-20 h-20 bg-white rounded-full shadow-xl flex items-center justify-center text-formal-accent group-hover:rotate-[360deg] transition-transform duration-1000">
                ...
                <h4 class="text-xl font-black text-formal-primary mb-2 tracking-tight">Keamanan Data</h4>
                <p class="text-sm text-formal-secondary font-medium px-10 mb-4">Semua data rekam medis dan pendaftaran
