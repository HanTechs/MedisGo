    ...
    <main class="w-full max-w-md relative z-10">
        <div class="bg-white/70 backdrop-blur-xl p-10 lg:p-12 rounded-[3.5rem] border border-slate-100 shadow-2xl">
            ...
            <div class="mb-10">
                ...
                <h2 class="text-2xl font-extrabold text-slate-900 tracking-tight italic">Atur Ulang <span
                        class="text-[oklch(50.7%_0.165_254.624)]">Kata Sandi</span></h2>
                <p class="text-slate-400 mt-1 font-medium text-xs">Buat kata sandi baru untuk mengamankan akun Anda.</p>
            </div>
            {{-- Header & Branding End --}}
            ...
            <form action="#" method="POST" class="space-y-6">
                ...
                <div class="relative group opacity-60">
                    <label
                        class="text-[10px] font-black uppercase tracking-widest text-slate-400 block mb-1.5">EMAIL</label>
                ...
                <div class="relative group">
                    <label
                        class="text-[10px] font-black uppercase tracking-widest text-slate-400 group-focus-within:text-[oklch(50.7%_0.165_254.624)] block mb-1.5 transition-colors">KATA
                        SANDI BARU</label>
                    <input type="password" name="password" placeholder="••••••••"
                        class="w-full py-3 bg-transparent border-b-2 border-slate-100 focus:border-[oklch(50.7%_0.165_254.624)] outline-none transition-all font-semibold text-slate-800 text-sm placeholder:text-slate-300"
                        required autofocus>
                </div>

                <div class="relative group">
                    <label
                        class="text-[10px] font-black uppercase tracking-widest text-slate-400 group-focus-within:text-[oklch(50.7%_0.165_254.624)] block mb-1.5 transition-colors">KONFIRMASI
                        KATA SANDI</label>
