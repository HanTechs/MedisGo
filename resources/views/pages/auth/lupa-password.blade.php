    ...
    <main class="w-full max-w-md relative z-10">
        <div class="bg-white/70 backdrop-blur-xl p-10 lg:p-12 rounded-[2.5rem] border border-cyan-50 shadow-2xl">
            ...
            <div class="mb-10">
                ...
                <h2 class="text-2xl font-extrabold text-formal-primary tracking-tight italic">Lupa Kata Sandi?</h2>
                <p class="text-formal-secondary mt-1 font-medium text-xs">Masukkan email Anda untuk mengatur ulang kata
                    sandi.
                </p>
            </div>
            {{-- Header & Branding End --}}
            ...
            <form action="#" method="POST" class="space-y-8">
                ...
                <div class="relative group">
                    <label
                        class="text-[10px] font-black uppercase tracking-widest text-formal-secondary group-focus-within:text-formal-accent block mb-1.5 transition-colors">EMAIL</label>
                    <input type="email" name="email" value="{{ old('email') }}"
                        placeholder="Masukkan email yang terdaftar"
                        class="w-full py-3.5 bg-transparent border-b-2 border-slate-100 focus:border-formal-accent outline-none transition-all font-semibold text-formal-primary text-sm"
                        required autofocus>
                </div>
                ...
                <div class="pt-4 space-y-4">
                    ...
                    <a href="{{ route('ShowLogin') }}"
                        class="block text-center text-[10px] font-black uppercase tracking-widest text-formal-secondary hover:text-formal-accent transition-colors">
                        KEMBALI KE LOGIN
                    </a>
                </div>
            </form>
